...
public class SecondProject extends AppCompatActivity {
    ...
    private int[] layouts;
    private Button btnSkip, btnNext, btncomp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dotsLayout = (LinearLayout) findViewById(R.id.layoutDots1);
        btnSkip = (Button) findViewById(R.id.btn_skip1);
        btnNext = (Button) findViewById(R.id.btn_next1);
        btncomp =(Button) findViewById(R.id.project2btn);


        // layouts of all welcome slider , add few more layouts
        layouts = new int[]{
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(SecondProject.this, MainActivity.class));
        finish();
    }
    ...
    {
        Intent intent = new Intent(SecondProject.this, Login.class);
